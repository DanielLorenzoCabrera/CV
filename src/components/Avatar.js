            ...
            >
              ...
              >
                ...
                <mask id="react-mask-68" fill="white">
                  <use xlinkHref="#react-path-67"></use>
                </mask>
                <use
                  id="Hoodie"
                  fill="#B7C1DB"
                  fillRule="evenodd"
                  xlinkHref="#react-path-67"
                ></use>
                <g
                  id="Color/Palette/Gray-01"
                  mask="url(#react-mask-68)"
                  fillRule="evenodd"
                  fill="#929598"
                >
              ...
              >
                <g id="Mouth/Smile" transform="translate(2.000000, 52.000000)">
                  ...
                  <mask id="react-mask-108" fill="white">
                    <use xlinkHref="#react-path-107"></use>
                  </mask>
                  <use
                    id="Mouth"
                    ...
                    fill="#000000"
                    fillRule="evenodd"
                    xlinkHref="#react-path-107"
                  ></use>
                  <rect
                    id="Teeth"
                    fill="#FFFFFF"
                    fillRule="evenodd"
                    mask="url(#react-mask-108)"
                    x="39"
                    y="2"
                    width="31"
                    height="16"
              ...
              <g id="Top" strokeWidth="1" fillRule="evenodd">
                ...
                <mask id="react-mask-9" fill="white">
                  <use xlinkHref="#react-path-11"></use>
                </mask>
                <g id="Mask"></g>
                  ...
                  <g transform="translate(-1.000000, 0.000000)">
                    ...
                    >
                      <mask id="react-mask-10" fill="white">
                        <use xlinkHref="#react-path-12"></use>
                      </mask>
                      <use
                        id="Mask-Hair"
                        fill="#944F23"
                        xlinkHref="#react-path-12"
                      ></use>
                      <g
                        id="Skin/👶🏽-03-Brown"
                    ...
                    >
                      ...
                      <mask id="react-mask-31" fill="white">
                        <use xlinkHref="#react-path-32"></use>
                      </mask>
                      <use
                        id="Lite-Beard"
                        fill="#331B0C"
                        fillRule="evenodd"
                        xlinkHref="#react-path-32"
                      ></use>
                      <g
                        id="Color/Hair/Brown"
                    ...
                    >
                      ...
                      <g id="Lennon-Glasses">
                        <use
                          fill="black"
                          fillOpacity="1"
                          filter="url(#react-filter-28)"
                          xlinkHref="#react-path-27"
                        ></use>
                        <use
                          fill="#252C2F"
                          fillRule="evenodd"
